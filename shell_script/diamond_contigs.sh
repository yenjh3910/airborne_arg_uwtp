...
do
	# Diamond
	# SARG blast
	diamond blastx -d ~/db/args_oap_db/SARG.dmnd -q ~/contigs_prodigal/${i}_contigs.nucl --id 50 -p 16 -e 1e-10 -k 1 --query-cover 50 -o  ~/contigs_diamond/SARG/${i}_contigs.SARG.dmnd

	# MGE blast
	diamond blastx -d  ~/db/MGE_db/MGE.dmnd -q ~/contigs_prodigal/${i}_contigs.nucl --id 50 -p 16 -e 1e-10 -k 1 --query-cover 50 -o ~/contigs_diamond/MGE/${i}_contigs.MGE.dmnd
