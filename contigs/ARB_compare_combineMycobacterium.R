# ARB_compare_combineMycobacterium.R
...
final_ARG_coverage$Genus <- gsub("Mycobacteroides", "Mycobacterium", final_ARG_coverage$Genus)
final_ARG_coverage$Genus <- gsub("Mycolicibacillus", "Mycobacterium", final_ARG_coverage$Genus)
final_ARG_coverage$Genus <- gsub("Mycolicibacterium", "Mycobacterium", final_ARG_coverage$Genus)
final_ARG_coverage$Genus <- gsub("Mycolicibacter", "Mycobacterium", final_ARG_coverage$Genus)

final_ARG_coverage$Species <- gsub("Mycobacteroides", "Mycobacterium", final_ARG_coverage$Species)
final_ARG_coverage$Species <- gsub("Mycolicibacillus", "Mycobacterium", final_ARG_coverage$Species)
final_ARG_coverage$Species <- gsub("Mycolicibacterium", "Mycobacterium", final_ARG_coverage$Species)
final_ARG_coverage$Species <- gsub("Mycolicibacter", "Mycobacterium", final_ARG_coverage$Species)
