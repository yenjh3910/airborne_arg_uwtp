# ARG_type_16S_abundance.R
# Calculate and visualize ARG type/16S gene in each sample
...
# Read ARG_type file
arg_type <- read.table("D:/ARG_project/Shell/args_oap/stage_two_output/normalized_16S.type.txt",
                   header = TRUE, sep = "")
...
# ggsave("test_ARG_type_16S.png", p, path = "D:/ARG_project/Figure/ARG", 
